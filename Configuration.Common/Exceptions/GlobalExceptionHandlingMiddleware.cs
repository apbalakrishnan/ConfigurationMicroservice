...
namespace Configuration.Common.Exceptions
{
    public class GlobalExceptionHandlingMiddleware
    {
        ...
        private static async Task HandleExceptionAsync(HttpContext context, Exception ex)
        {
            ...
            {
                Status = AppConstants.Status.Error.ToString(),
                TimeStamp = System.DateTime.Now,
                DeveloperMessage = (ex.Message.Contains("See inner exception for details") ? ex.InnerException.Message : ex.Message)
            };
